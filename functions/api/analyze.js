 ...
 *
 * Receives multipart/form-data with an audio file,
 * sends it to Gemini, and returns structured JSON:
 ...
 * NOT raw word frequency. This directly addresses the brief requirement.
 */
...
function geminiErrorResponse(status, rawMessage) {
  if (status === 400) {
    return {
      ...
      userMessage:
        "The audio file could not be processed. Please try a different recording.",
    };
  }
